...
/**
 * @brief STM32F7XX Standard Peripherals Library version number V1.0.0
   */
#define __STM32F7XX_STDPERIPH_VERSION_MAIN   (0x01) /*!< [31:24] main version */                                  
#define __STM32F7XX_STDPERIPH_VERSION_SUB1   (0x00) /*!< [23:16] sub1 version */
#define __STM32F7XX_STDPERIPH_VERSION_SUB2   (0x00) /*!< [15:8]  sub2 version */
#define __STM32F7XX_STDPERIPH_VERSION_RC     (0x00) /*!< [7:0]  release candidate */ 
...
#define __MPU_PRESENT             1       /*!< STM32F7XX provides an MPU                     */
#define __NVIC_PRIO_BITS          4       /*!< STM32F7XX uses 4 Bits for the Priority Levels */
