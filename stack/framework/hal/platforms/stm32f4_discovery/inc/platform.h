...
#ifndef PLATFORM_STM32F4_DISCOVERY
    #error Mismatch between the configured platform and the actual platform. Expected PLATFORM_STM32F4_DISCOVERY to be defined
#endif
